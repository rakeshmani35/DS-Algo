...
public class FindPairsOfSumIsXOfTwoUnsortedArray {
	...
	public static Map<Integer, Integer> findPairs_MapWithoutDulicate(int arr1[], int arr2[], int sum) {
	...
	public static void main(String[] args) {
		...
		Map<Integer, Integer> result = findPairs_MapWithoutDulicate(new int[] { 2, 4, 8, 5, 3 },
				new int[] { 5, 6, 9, 3, 4 }, sum);
		System.out.println("\n"+result);
	}
